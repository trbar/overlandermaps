...
public:
  ...
  enum EType : int8_t
  {
    ...
    FMD_CONTACT_VK = 35,
    FMD_CONTACT_LINE = 36,
    FMD_OVERLANDER_ID = 37,
    FMD_OVERLANDER_CATEGORY = 38,
    FMD_OVERLANDER_SOURCE = 39,
    FMD_OVERLANDER_DESCRIPTION = 40,
    FMD_OVERLANDER_SERVICES = 41,
    FMD_OVERLANDER_ACTIVITIES = 42,
    FMD_OVERLANDER_LINK = 43,
    FMD_OVERLANDER_RATING = 44,
    FMD_OVERLANDER_TAGS = 45,
    FMD_OVERLANDER_CHECKIN3 = 46,
    FMD_OVERLANDER_CHECKIN2 = 47,
    FMD_OVERLANDER_CHECKIN1 = 48,
    FMD_COUNT
  };
