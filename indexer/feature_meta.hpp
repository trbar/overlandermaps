...
public:
  ...
  enum EType : int8_t
  {
    ...
    FMD_CONTACT_VK = 35,
    FMD_CONTACT_LINE = 36,
    FMD_OVERLANDER_ID = 39,
    FMD_OVERLANDER_SOURCE = 40,
    FMD_OVERLANDER_DESCRIPTION = 41,
    FMD_OVERLANDER_SERVICES = 42,
    FMD_OVERLANDER_ACTIVITIES = 43,
    FMD_OVERLANDER_LINK = 44,
    FMD_OVERLANDER_RATING = 45,
