...
public:
  ...
  void SetOverlanderActivities(std::string const & activities);
  void SetOverlanderLink(std::string const & link);
  void SetOverlanderRating(std::string const & rating);
  void SetOverlanderTags(std::string const & tags);
