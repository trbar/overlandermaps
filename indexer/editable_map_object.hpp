...
public:
  ...
  void SetOverlanderLocation(std::string const & location);
  void SetOverlanderDescription(std::string const & description);
  void SetOverlanderOpen(std::string const & open);
  void SetOverlanderElectricity(std::string const & electricity);
  void SetOverlanderWifi(std::string const & wifi);
  void SetOverlanderKitchen(std::string const & kitchen);
  void SetOverlanderParking(std::string const & parking);
  void SetOverlanderRestaurant(std::string const & restaurant);
  void SetOverlanderShowers(std::string const & showers);
  void SetOverlanderWater(std::string const & water);
  void SetOverlanderToilets(std::string const & toilets);
  void SetOverlanderBigrigfriendly(std::string const & bigrigfriendly);
  void SetOverlanderTentfriendly(std::string const & tentfriendly);
  void SetOverlanderPetfriendly(std::string const & petfriendly);
  void SetOverlanderSanidump(std::string const & sanidump);
  void SetOverlanderBiofuel(std::string const & biofuel);
  void SetOverlanderRepairsvehicles(std::string const & repairsvehicles);
  void SetOverlanderRepairsmotorcycles(std::string const & repairsmotorcycles);
  void SetOverlanderRepairsbicycles(std::string const & repairsbicycles);
  void SetOverlanderSellsparts(std::string const & sellsparts);
  void SetOverlanderRecyclesbatteries(std::string const & recyclesbatteries);
  void SetOverlanderRecyclesoil(std::string const & recyclesoil);
  void SetOverlanderCheckin5id(std::string const & checkin5id);
  void SetOverlanderCheckin5time(std::string const & checkin5time);
  void SetOverlanderCheckin5author(std::string const & checkin5author);
  void SetOverlanderCheckin5comment(std::string const & checkin5comment);
  void SetOverlanderCheckin4id(std::string const & checkin4id);
  void SetOverlanderCheckin4time(std::string const & checkin4time);
  void SetOverlanderCheckin4author(std::string const & checkin4author);
  void SetOverlanderCheckin4comment(std::string const & checkin4comment);
  void SetOverlanderCheckin3id(std::string const & checkin3id);
  void SetOverlanderCheckin3time(std::string const & checkin3time);
  void SetOverlanderCheckin3author(std::string const & checkin3author);
  void SetOverlanderCheckin3comment(std::string const & checkin3comment);
  void SetOverlanderCheckin2id(std::string const & checkin2id);
  void SetOverlanderCheckin2time(std::string const & checkin2time);
  void SetOverlanderCheckin2author(std::string const & checkin2author);
  void SetOverlanderCheckin2comment(std::string const & checkin2comment);
  void SetOverlanderCheckin1id(std::string const & checkin1id);
  void SetOverlanderCheckin1time(std::string const & checkin1time);
  void SetOverlanderCheckin1author(std::string const & checkin1author);
