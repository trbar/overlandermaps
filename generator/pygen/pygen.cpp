...
BOOST_PYTHON_MODULE(pygen)
{
  ...
  }
  {
    ...
    bp::enum_<Metadata::EType>("EType")
        ...
        .value("overlander_id", Metadata::EType::FMD_OVERLANDER_ID)
        .value("overlander_category", Metadata::EType::FMD_OVERLANDER_CATEGORY)
        .value("overlander_source", Metadata::EType::FMD_OVERLANDER_SOURCE)
        .value("overlander_description", Metadata::EType::FMD_OVERLANDER_DESCRIPTION)
        .value("overlander_services", Metadata::EType::FMD_OVERLANDER_SERVICES)
        .value("overlander_activities", Metadata::EType::FMD_OVERLANDER_ACTIVITIES)
        .value("overlander_link", Metadata::EType::FMD_OVERLANDER_LINK)
        .value("overlander_rating", Metadata::EType::FMD_OVERLANDER_RATING)
