...
BOOST_PYTHON_MODULE(pygen)
{
  ...
  }
  {
    ...
    bp::enum_<Metadata::EType>("EType")
        ...
        .value("overlander_location", Metadata::EType::FMD_OVERLANDER_LOCATION)
        .value("overlander_description", Metadata::EType::FMD_OVERLANDER_DESCRIPTION)
        .value("overlander_open", Metadata::EType::FMD_OVERLANDER_OPEN)
        .value("overlander_electricity", Metadata::EType::FMD_OVERLANDER_ELECTRICITY)
        .value("overlander_wifi", Metadata::EType::FMD_OVERLANDER_WIFI)
        .value("overlander_kitchen", Metadata::EType::FMD_OVERLANDER_KITCHEN)
        .value("overlander_parking", Metadata::EType::FMD_OVERLANDER_PARKING)
        .value("overlander_restaurant", Metadata::EType::FMD_OVERLANDER_RESTAURANT)
        .value("overlander_showers", Metadata::EType::FMD_OVERLANDER_SHOWERS)
        .value("overlander_water", Metadata::EType::FMD_OVERLANDER_WATER)
        .value("overlander_toilets", Metadata::EType::FMD_OVERLANDER_TOILETS)
        .value("overlander_bigrigfriendly", Metadata::EType::FMD_OVERLANDER_BIGRIGFRIENDLY)
        .value("overlander_tentfriendly", Metadata::EType::FMD_OVERLANDER_TENTFRIENDLY)
        .value("overlander_petfriendly", Metadata::EType::FMD_OVERLANDER_PETFRIENDLY)
        .value("overlander_sanidump", Metadata::EType::FMD_OVERLANDER_SANIDUMP)
        .value("overlander_biofuel", Metadata::EType::FMD_OVERLANDER_BIOFUEL)
        .value("overlander_repairsvehicles", Metadata::EType::FMD_OVERLANDER_REPAIRSVEHICLES)
        .value("overlander_repairsmotorcycles", Metadata::EType::FMD_OVERLANDER_REPAIRSMOTORCYCLES)
        .value("overlander_repairsbicycles", Metadata::EType::FMD_OVERLANDER_REPAIRSBICYCLES)
        .value("overlander_sellsparts", Metadata::EType::FMD_OVERLANDER_SELLSPARTS)
        .value("overlander_recyclesbatteries", Metadata::EType::FMD_OVERLANDER_RECYCLESBATTERIES)
        .value("overlander_recyclesoil", Metadata::EType::FMD_OVERLANDER_RECYCLESOIL)
        .value("overlander_checkin5id", Metadata::EType::FMD_OVERLANDER_CHECKIN5ID)
        .value("overlander_checkin5time", Metadata::EType::FMD_OVERLANDER_CHECKIN5TIME)
        .value("overlander_checkin5author", Metadata::EType::FMD_OVERLANDER_CHECKIN5AUTHOR)
        .value("overlander_checkin5comment", Metadata::EType::FMD_OVERLANDER_CHECKIN5COMMENT)
        .value("overlander_checkin4id", Metadata::EType::FMD_OVERLANDER_CHECKIN4ID)
        .value("overlander_checkin4time", Metadata::EType::FMD_OVERLANDER_CHECKIN4TIME)
        .value("overlander_checkin4author", Metadata::EType::FMD_OVERLANDER_CHECKIN4AUTHOR)
        .value("overlander_checkin4comment", Metadata::EType::FMD_OVERLANDER_CHECKIN4COMMENT)
        .value("overlander_checkin3id", Metadata::EType::FMD_OVERLANDER_CHECKIN3ID)
        .value("overlander_checkin3time", Metadata::EType::FMD_OVERLANDER_CHECKIN3TIME)
        .value("overlander_checkin3author", Metadata::EType::FMD_OVERLANDER_CHECKIN3AUTHOR)
        .value("overlander_checkin3comment", Metadata::EType::FMD_OVERLANDER_CHECKIN3COMMENT)
        .value("overlander_checkin2id", Metadata::EType::FMD_OVERLANDER_CHECKIN2ID)
        .value("overlander_checkin2time", Metadata::EType::FMD_OVERLANDER_CHECKIN2TIME)
        .value("overlander_checkin2author", Metadata::EType::FMD_OVERLANDER_CHECKIN2AUTHOR)
        .value("overlander_checkin2comment", Metadata::EType::FMD_OVERLANDER_CHECKIN2COMMENT)
        .value("overlander_checkin1id", Metadata::EType::FMD_OVERLANDER_CHECKIN1ID)
        .value("overlander_checkin1time", Metadata::EType::FMD_OVERLANDER_CHECKIN1TIME)
        .value("overlander_checkin1author", Metadata::EType::FMD_OVERLANDER_CHECKIN1AUTHOR);
