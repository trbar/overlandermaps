...
static unordered_map<string, EType> const kNamesToFMD = {
    ...
    {"overlander_activities", feature::Metadata::FMD_OVERLANDER_ACTIVITIES},
    {"overlander_link", feature::Metadata::FMD_OVERLANDER_LINK},
    {"overlander_rating", feature::Metadata::FMD_OVERLANDER_RATING},
    {"overlander_tags", feature::Metadata::FMD_OVERLANDER_TAGS},
    {"overlander_checkin3", feature::Metadata::FMD_OVERLANDER_CHECKIN3},
    {"overlander_checkin2", feature::Metadata::FMD_OVERLANDER_CHECKIN2},
    {"overlander_checkin1", feature::Metadata::FMD_OVERLANDER_CHECKIN1},
    {"overlander_spots", feature::Metadata::FMD_OVERLANDER_SPOTS},
    {"overlander_open", feature::Metadata::FMD_OVERLANDER_OPEN},
    {"overlander_serviceprices", feature::Metadata::FMD_OVERLANDER_SERVICEPRICES},
    {"overlander_parkingprices", feature::Metadata::FMD_OVERLANDER_PARKINGPRICES},
